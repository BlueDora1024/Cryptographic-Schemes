...
{
	Parser parser(argc, argv, "SchemeVPSICAAlg2");
	...
	const SaverRow row = {
		std::string("SchemeVPSICAAlg2"), std::uint64_t{kBit}, std::uint64_t{m}, std::uint64_t{n}, static_cast<std::uint64_t>(options.runCount),
