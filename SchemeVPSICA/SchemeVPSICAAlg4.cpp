...
{
	Parser parser(argc, argv, "SchemeVPSICAAlg4");
	...
	const SaverRow row = {
		std::string("SchemeVPSICAAlg4"), std::uint64_t{kBit}, std::uint64_t{m}, std::uint64_t{n}, std::uint64_t{l}, static_cast<std::uint64_t>(options.runCount),
